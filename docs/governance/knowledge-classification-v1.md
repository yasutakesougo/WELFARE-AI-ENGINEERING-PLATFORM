...
Do not claim causal transfer from one repository to another unless evidence supports it. Structural equivalence is recorded as `ADOPTED_EQUIVALENT`, not as copied knowledge.

## Required Evidence

A promoted record must identify:
